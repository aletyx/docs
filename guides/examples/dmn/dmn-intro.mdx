...
The best way to learn DMN is by creating your first model. In the next guide, [Your First DMN Model](/guides/examples/dmn/dmn-basic-example), we'll walk through creating a simple vacation days calculation model that demonstrates the key concepts of DMN.
