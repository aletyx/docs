...
description: "Advanced DMN modeling with Business Knowledge Models (BKMs), custom data types, list operations, hit policies, and FEEL context expressions, built through a travel insurance pricing example."
source: "https://aletyx-docs-preview.aletyx.workers.dev/guides/examples/dmn/dmn-deeper/"
---
...
[![Traveler Data Model](/images/guides/guides/examples/dmn/images/traveler-data-model.png)](/images/guides/guides/examples/dmn/images/traveler-data-model.png)
...
[![Claim Data Model](/images/guides/guides/examples/dmn/images/claim-data-model.png)](/images/guides/guides/examples/dmn/images/claim-data-model.png)
...
[![Trip Details Data Model](/images/guides/guides/examples/dmn/images/trip-details-model.png)](/images/guides/guides/examples/dmn/images/trip-details-model.png)
...
[![Base Premium](/images/guides/guides/examples/dmn/images/base-premium.png)](/images/guides/guides/examples/dmn/images/base-premium.png)
...
[![Claims Assessment](/images/guides/guides/examples/dmn/images/claims-assessment.png)](/images/guides/guides/examples/dmn/images/claims-assessment.png)
...
[![Medical Assessment](/images/guides/guides/examples/dmn/images/medical-assessment.png)](/images/guides/guides/examples/dmn/images/medical-assessment.png)
...
[![Destination Risk Factor](/images/guides/guides/examples/dmn/images/destination-risk-factor.png)](/images/guides/guides/examples/dmn/images/destination-risk-factor.png)
...
2. Edit *ContextEntry-1* to being **Highest Risk** with a type string by clicking the first box.
  ...
  [![Context Expression for Risk Assessment](/images/guides/guides/examples/dmn/images/highest-risk-context.png)](/images/guides/guides/examples/dmn/images/highest-risk-context.png)

  Context Variable
  In a Context expression, you first define named variables that can be used within the calculation. "Highest Risk" is defined here as a string variable. This is the value that can be used in the next parts of your decision. By clicking this box, you will open the definition window for the particular Context variable you are selected to.

  Context Variable Definition
  In a Context expression, you first define named variables that can be used within the calculation. "Highest Risk" is defined here as a string variable. This is the value that can be used in the next parts of your decision. What you name in this box will define the context variable for the returned value for the rest of this Context Decision particular Context variable you are selected to.

  Data Type Dropdown
  DMN requires explicit typing of all variables. This dropdown allows selection from built-in types (string, number, boolean, date) or custom-defined complex types.

  Type Management
  The "Manage" button provides access to create, edit or import custom data types for use in your decision model.
