...
[![Applying an Accelerator](/images/guides/guides/examples/dmn/images/apply-accelerator.gif)](/images/guides/guides/examples/dmn/images/apply-accelerator.gif)
...
1. Deploy your decision service (covered in [Basic Deployment Options](/guides/examples/dmn/dmn-basic-deployment))
...
Ready to deploy? Continue to [Basic Deployment Options](/guides/examples/dmn/dmn-basic-deployment)!
