...
<CardGroup cols={3}>
  <Card title="For Decision Analysts">
    ...
    - [Start with Aletyx!](/guides/getting-started/getting-started-start-aletyx) - Generate project templates
  </Card>
...
3. **Use Ready-Made Templates**
    * [Getting Started with Aletyx Project Starter](/guides/getting-started/getting-started-start-aletyx)
