...
2. Edit _ContextEntry-1_ to being **Highest Risk** with a type string by clicking the first box.
    ...
    <img src="/images/guides/examples/dmn/images/highest-risk-context.png" class="annotated-image" alt="Context Expression for Risk Assessment">
...
5. Last on the _<result>_ input, we will return the **Risk Factor** - in DMN 1.5, you can simply put Risk Factor here to return the risk factor based on the highest deemed risk!
    ...
    <img src="/images/guides/examples/dmn/images/destination-risk-factor-context.png" class="annotated-image" alt="Full Context Expression Implementation">
