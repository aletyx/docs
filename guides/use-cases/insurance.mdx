...
<Frame>
  <img src="/images/uc-insurance-flow-1.svg" alt="Property and casualty claims processing flowchart" className="block dark:hidden" />
<img src="/images/uc-insurance-flow-1-dark.svg" alt="Property and casualty claims processing flowchart" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/uc-insurance-flow-2.svg" alt="Health insurance claims processing flowchart" className="block dark:hidden" />
<img src="/images/uc-insurance-flow-2-dark.svg" alt="Health insurance claims processing flowchart" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/uc-insurance-flow-3.svg" alt="Claims fraud investigation flowchart" className="block dark:hidden" />
<img src="/images/uc-insurance-flow-3-dark.svg" alt="Claims fraud investigation flowchart" className="hidden dark:block" />
</Frame>
