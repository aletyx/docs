...
<Frame>
  <img src="/images/uc-lending-flow-1.svg" alt="Commercial loan approval process flowchart" className="block dark:hidden" />
<img src="/images/uc-lending-flow-1-dark.svg" alt="Commercial loan approval process flowchart" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/uc-lending-flow-2.svg" alt="Mortgage application processing flowchart" className="block dark:hidden" />
<img src="/images/uc-lending-flow-2-dark.svg" alt="Mortgage application processing flowchart" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/uc-lending-flow-3.svg" alt="Credit limit increase request flowchart" className="block dark:hidden" />
<img src="/images/uc-lending-flow-3-dark.svg" alt="Credit limit increase request flowchart" className="hidden dark:block" />
</Frame>
