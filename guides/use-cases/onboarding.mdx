...
description: "Automate customer onboarding with BPMN workflows and decision rules - financial services KYC/AML, telecom service activation, and healthcare patient intake use cases."
---
...
<Frame>
  <img src="/images/uc-onboarding-flow-1.svg" alt="Financial services customer onboarding flowchart" className="block dark:hidden" />
<img src="/images/uc-onboarding-flow-1-dark.svg" alt="Financial services customer onboarding flowchart" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/uc-onboarding-flow-2.svg" alt="Telecom service activation flowchart" className="block dark:hidden" />
<img src="/images/uc-onboarding-flow-2-dark.svg" alt="Telecom service activation flowchart" className="hidden dark:block" />
</Frame>
...
<Frame>
  <img src="/images/uc-onboarding-flow-3.svg" alt="Healthcare patient onboarding flowchart" className="block dark:hidden" />
<img src="/images/uc-onboarding-flow-3-dark.svg" alt="Healthcare patient onboarding flowchart" className="hidden dark:block" />
</Frame>
