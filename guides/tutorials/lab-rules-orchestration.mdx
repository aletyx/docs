...
sidebarTitle: "Rules Orchestration Lab"
description: "Create a BPMN process that orchestrates a DMN decision and a DRL RuleUnit to validate a driver's license and evaluate traffic violations."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/processes/basic-bpmn/lab-rules-orchestration/"
---
...
![Traffic Rules and Decisions Orchestration](/images/guides/tutorials/rules-orchestration-lab.png)
