...
description: "Deploy a DMN model as a containerized REST decision service using Aletyx Playground dev deployments, test it via Swagger UI, and optionally deploy to OpenShift."
source: "https://aletyx-docs-preview.aletyx.workers.dev/guides/examples/dmn/dmn-basic-deployment/"
---
...
We'll focus on the development deployment capabilities of Aletyx Playground to get you started quickly. For production deployments, see our [Advanced Deployment Options](/guides/tutorials/dmn/dmn-advanced-deployment) guide.
...
{/* TODO: missing image — "Development Deployment Process" (images/dev-deployment-process.png); source returns 404, re-add when the asset is available */}
...
{/* TODO: missing image — "Swagger UI for Deployed Service" (images/swagger-ui.png); source returns 404, re-add when the asset is available */}
...
{/* TODO: missing image — "Deployment Architecture" (images/deployment-architecture.png); source returns 404, re-add when the asset is available */}
...
1. Follow the [Advanced Deployment Options](/guides/tutorials/dmn/dmn-advanced-deployment) guide
...
Remember that this is just the beginning of your deployment journey. For production use, you'll need to implement more robust deployment patterns as covered in the [Advanced Deployment Options](/guides/tutorials/dmn/dmn-advanced-deployment) guide.
