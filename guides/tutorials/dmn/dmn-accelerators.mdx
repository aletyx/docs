---
title: "DMN Accelerators"
description: "Accelerators in Aletyx Playground are powerful templates that transform your standalone DMN models into fully structured projects ready for deployment."
source: "https://aletyx-docs-preview.aletyx.workers.dev/guides/examples/dmn/dmn-accelerators/"
---
...
[![Applying an Accelerator](/images/guides/guides/tutorials/dmn/images/apply-accelerator.gif)](/images/guides/guides/tutorials/dmn/images/apply-accelerator.gif)
...
3. If you haven't connected your GitHub account, you'll need to authorize Aletyx Playground
...
{/* TODO: missing image — "GitHub Synchronization" (images/github-sync.png); source returns 404, re-add when the asset is available */}
...
1. Deploy your decision service (covered in [Basic Deployment Options](/guides/tutorials/dmn/dmn-basic-deployment))
...
Ready to deploy? Continue to [Basic Deployment Options](/guides/tutorials/dmn/dmn-basic-deployment)!
