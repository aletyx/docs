---
title: "Introduction to DMN"
description: "Introduction to DMN decision modeling - Decision Requirements Diagrams, decision tables, hit policies, FEEL expressions, and executable models in the Apache KIE ecosystem."
source: "https://aletyx-docs-preview.aletyx.workers.dev/guides/examples/dmn/dmn-intro/"
---
...
{/* TODO: missing image — "DMN Elements" (images/dmn-elements.png); source returns 404, re-add when the asset is available */}
...
The best way to learn DMN is by creating your first model. In the next guide, [Your First DMN Model](/guides/tutorials/dmn/dmn-basic-example), we'll walk through creating a simple vacation days calculation model that demonstrates the key concepts of DMN.
