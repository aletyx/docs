...
sidebarTitle: "Ad-Hoc Subprocesses"
description: "Ad-hoc subprocesses provide flexibility by allowing tasks within them to be executed in a non-sequential order, for scenarios where the exact sequence of activities cannot be predetermined."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/processes/advanced-bpmn/sub-adhoc/"
---
...
![Ad-hoc Subprocesses](/images/guides/tutorials/sub-adhoc.png)
