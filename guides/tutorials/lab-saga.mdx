...
sidebarTitle: "SAGA Pattern Lab"
description: "Model an order process with service tasks, gateways, and compensatory actions that simulate the SAGA pattern using a data-driven flow approach."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/processes/basic-bpmn/lab-saga/"
---
...
![Saga Pattern Lab](/images/guides/tutorials/saga-lab.png)
