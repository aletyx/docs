...
sidebarTitle: "Event-Driven Lab"
description: "Interact with decisions and the rule engine using Kafka topics, and create processes that interact with Kafka topics using Messages nodes."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/processes/advanced-bpmn/lab-eda/"
---
