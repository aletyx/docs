...
<img src="/images/deployment/ecs-architecture.svg" alt="Amazon ECS deployment architecture" className="block dark:hidden" />
<img src="/images/deployment/ecs-architecture-dark.svg" alt="Amazon ECS deployment architecture" className="hidden dark:block" />
