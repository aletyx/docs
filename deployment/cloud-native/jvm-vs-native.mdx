---
title: "JVM vs Native"
description: "As you deploy decision and process services built with Aletyx Enterprise Build of Kogito and Drools, choosing between traditional JVM deployment and Native Image compilation is a critical decision tha"
...
[![Diagram](/images/deployment/assets/diagrams/deployment/cloud-native/jvm-vs-native/flowchart-td-1.svg)](https://docs.aletyx.ai/assets/diagrams/deployment/cloud-native/jvm-vs-native/flowchart-td-1.svg)

### Native Image Deployment

The GraalVM Native Image approach compiles your application to a standalone executable:

[![Diagram](/images/deployment/assets/diagrams/deployment/cloud-native/jvm-vs-native/flowchart-td-2.svg)](https://docs.aletyx.ai/assets/diagrams/deployment/cloud-native/jvm-vs-native/flowchart-td-2.svg)
