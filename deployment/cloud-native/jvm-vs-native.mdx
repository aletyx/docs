---
title: "JVM vs Native"
description: "Compare JVM and GraalVM Native Image deployment for Kogito decision and process services - startup time, memory footprint, scaling, and when to choose each."
source: "https://docs.aletyx.ai/deployment/cloud-native/jvm-vs-native/"
---
...
[<img src="/images/deployment/assets/diagrams/deployment/cloud-native/jvm-vs-native/flowchart-td-1.svg" alt="Diagram" className="block dark:hidden" />
<img src="/images/deployment/assets/diagrams/deployment/cloud-native/jvm-vs-native/flowchart-td-1-dark.svg" alt="Diagram" className="hidden dark:block" />](https://docs.aletyx.ai/assets/diagrams/deployment/cloud-native/jvm-vs-native/flowchart-td-1.svg)

### Native Image Deployment

The GraalVM Native Image approach compiles your application to a standalone executable:

[<img src="/images/deployment/assets/diagrams/deployment/cloud-native/jvm-vs-native/flowchart-td-2.svg" alt="Diagram" className="block dark:hidden" />
<img src="/images/deployment/assets/diagrams/deployment/cloud-native/jvm-vs-native/flowchart-td-2-dark.svg" alt="Diagram" className="hidden dark:block" />](https://docs.aletyx.ai/assets/diagrams/deployment/cloud-native/jvm-vs-native/flowchart-td-2.svg)
...
- [Aletyx Enterprise Build of Kogito and Drools Deployment Guide](/deployment/kubernetes)
