...
description: "Deploy Aletyx Decision Control Sandbox with an embedded H2 database for quick evaluation, proofs-of-concept, and development environments."
source: "https://docs.aletyx.ai/deployment/aws-marketplace/sandbox/"
---
...
- See [SSL/HTTPS Configuration](/deployment/aws-marketplace/ssl-https) for details
...
- **Enable SSL/HTTPS**: [SSL/HTTPS Configuration](/deployment/aws-marketplace/ssl-https)
