...
1. [Start a Project from start.aletyx.ai](/guides/getting-started/getting-started-start-aletyx)
2. [Explore the Aletyx Playground](/guides/getting-started/getting-started-playground)
3. [Learn about the core components](/architecture/overview)
