...
sidebarTitle: "Cloud Tools"
description: "Install and configure the Kubernetes CLI (kubectl) and Red Hat OpenShift CLI (oc) for Aletyx Enterprise Build of Kogito and Drools."
source: "https://aletyx-docs-preview.aletyx.workers.dev/getting-started/cloud-tools/"
---
