...
description: "Connect Aletyx Playground to GitHub to publish projects, synchronize changes, and deploy through traditional deployment pipelines."
source: "https://aletyx-docs-preview.aletyx.workers.dev/getting-started/git-configuration/"
---
