...
2.  This opens a sample "Loan Pre-qualification" DMN model (DMN 1.5 Specification).
    ...
    <img src="/images/guides/getting-started/images/dmn-editor.png" alt="DMN Editor with Decision Table">
...
5.  This decision table is used to determine the credit ratings based on FICO scores. If you hover over each icon, it will describe different parts of the Decision Table.
    ...
    <img src="/images/guides/getting-started/images/credit-score-dmn-edit.png" alt="DMN Editor with Decision Table">
    <!-- Orange plus marker for the highlighted text field -->
