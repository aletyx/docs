...
![Aletyx Playground Welcome Screen](/images/guides/getting-started/images/playground_welcome.png)
...
- **Settings** (gear icon): Configure your Playground instance, including DMN version settings
- **Profile** (user icon): Configure connections to Git providers and Kubernetes environments
...
2.  This opens a sample "Loan Pre-qualification" DMN model (DMN 1.5 Specification).
    ...
    ![DMN Editor with Decision Table](/images/guides/getting-started/images/dmn-editor.png)

<Accordion title="View Sample DMN Model">
![Sample DMN Model](/images/guides/getting-started/images/dmn-sample-view.png)
</Accordion>
...
5.  This decision table is used to determine the credit ratings based on FICO scores. If you hover over each icon, it will describe different parts of the Decision Table.
    ...
    ![DMN Editor with Decision Table](/images/guides/getting-started/images/credit-score-dmn-edit.png)
...
![Demo of Extra Days](/images/guides/getting-started/images/extra-days-case-1.gif)
</Accordion>
...
![Demo of Extra Days](/images/guides/getting-started/images/default-to-zero.gif)
</Accordion>
...
![Demo of Extra Days](/images/guides/getting-started/images/extra-days-case-2.gif)
</Accordion>
...
![Demo of Extra Days](/images/guides/getting-started/images/extra-days-case-3.gif)
</Accordion>
...
![Demo of Base Days](/images/guides/getting-started/images/base-vacation-days.gif)
</Accordion>
...
![Demo of Total Vacation Days](/images/guides/getting-started/images/drawing-total-vacation-days.gif)
</Accordion>
...
![Demo of Total Vacation Days](/images/guides/getting-started/images/total-vacation-days.gif)
</Accordion>
