...
![BPMN Editor with Sample Hiring Process](/images/guides/getting-started/images/hiring-process-full.png)
...
The BPMN End Node signifies the end of a process drawn in BPMN for the particular instance. This is the palette item used for various end nodes. To learn more about these see [End Events Reference](../../../core/processes/basic-bpmn/end-events).

The BPMN Activities nodes are used to create activities that occur in the BPMN process. Activities include: User tasks, Business Rules tasks, Script tasks, and Service tasks. To learn more about these see [BPMN Activities Reference](../../../core/processes/basic-bpmn/activities).
