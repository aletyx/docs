...
description: "Test DMN decision services with Kogito test scenarios - author .scesim files in VS Code using GIVEN and EXPECT tables, then run them with Maven and JUnit."
