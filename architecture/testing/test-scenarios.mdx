...
description: "As a developer working with business process and decision automation, you'll quickly discover that business decisions are the backbone of your automation systems."
source: "https://aletyx-docs-preview.aletyx.workers.dev/test-scenarios/authoring-scesim/"
---
...
1. **Add test scenarios** (rows) with different inputs and expected outputs:
...
3. **Create List**: Add list values using a guided form
4. **Define List**: Define a list using FEEL syntax
