...
[![Diagram contrasting Orchestration and Choreography: in orchestration a central Orchestrator Process invokes Service A, B and C; in choreography the services coordinate by reacting to events](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-1.svg)](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-1.svg)
...
[![Flowchart of a REST service task example: Start, Validate Application, a 'Get Credit Score' service task, then a 'Score 700 or above?' decision; yes leads to Approve, no leads to Reject, then End](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-lr-2.svg)](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-lr-2.svg)
...
[![Flowchart of sequential service orchestration: Start, Validate Data, Check Credit Score, Verify Employment, Calculate DTI Ratio, Determine Eligibility, End](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-lr-4.svg)](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-lr-4.svg)
...
[![Flowchart of parallel service orchestration: after Start a parallel gateway calls the Experian, Equifax and TransUnion APIs concurrently, then a join gateway leads to Aggregate Scores and End](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-5.svg)](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-5.svg)
...
[![Flowchart of conditional service routing: after Start the process branches on product type to the Mortgage, Auto Loan or Personal Loan pricing service, then converges on Generate Quote](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-6.svg)](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-6.svg)
...
[![Flowchart of error handling: Start, Primary Service, End; an error boundary event on the Primary Service diverts to a Fallback Service when an error occurs](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-7.svg)](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-7.svg)
...
[![Flowchart of compensation handling: Reserve Inventory then Charge Payment; if an error occurs, compensation runs Release Inventory and Cancel Order](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-lr-8.svg)](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-lr-8.svg)
...
[![Flowchart of an orchestrated saga: Start Order, Reserve Inventory, Charge Payment, Ship Order, End Success; on failure, compensating steps Refund Payment, Release Inventory and Cancel Order lead to End Cancelled](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-9.svg)](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-9.svg)
