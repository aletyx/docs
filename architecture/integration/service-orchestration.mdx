...
description: "Orchestrate multi-service workflows with BPMN Service Tasks - REST and Java calls, async execution, sequential, parallel, conditional routing, error handling, and saga compensation."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/integration/service-orchestration/"
---
...
[<img src="/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-1.svg" alt="Diagram contrasting Orchestration and Choreography: in orchestration a central Orchestrator Process invokes Service A, B and C; in choreography the services coordinate by reacting to events" className="block dark:hidden" />
<img src="/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-1-dark.svg" alt="Diagram contrasting Orchestration and Choreography: in orchestration a central Orchestrator Process invokes Service A, B and C; in choreography the services coordinate by reacting to events" className="hidden dark:block" />](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-1.svg)
...
[![Service Task Node](/images/architecture/core/processes/basic-bpmn/images/service-task-node.png)](/images/architecture/core/processes/basic-bpmn/images/service-task-node.png)
...
See [BPMN Activities](/architecture/processes/basic-bpmn/activities) for detailed Service Task configuration.
...
[<img src="/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-lr-2.svg" alt="Flowchart of a REST service task example: Start, Validate Application, a 'Get Credit Score' service task, then a 'Score 700 or above?' decision; yes leads to Approve, no leads to Reject, then End" className="block dark:hidden" />
<img src="/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-lr-2-dark.svg" alt="Flowchart of a REST service task example: Start, Validate Application, a 'Get Credit Score' service task, then a 'Score 700 or above?' decision; yes leads to Approve, no leads to Reject, then End" className="hidden dark:block" />](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-lr-2.svg)
...
[<img src="/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-lr-4.svg" alt="Flowchart of sequential service orchestration: Start, Validate Data, Check Credit Score, Verify Employment, Calculate DTI Ratio, Determine Eligibility, End" className="block dark:hidden" />
<img src="/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-lr-4-dark.svg" alt="Flowchart of sequential service orchestration: Start, Validate Data, Check Credit Score, Verify Employment, Calculate DTI Ratio, Determine Eligibility, End" className="hidden dark:block" />](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-lr-4.svg)
...
[<img src="/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-5.svg" alt="Flowchart of parallel service orchestration: after Start a parallel gateway calls the Experian, Equifax and TransUnion APIs concurrently, then a join gateway leads to Aggregate Scores and End" className="block dark:hidden" />
<img src="/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-5-dark.svg" alt="Flowchart of parallel service orchestration: after Start a parallel gateway calls the Experian, Equifax and TransUnion APIs concurrently, then a join gateway leads to Aggregate Scores and End" className="hidden dark:block" />](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-5.svg)
...
[<img src="/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-6.svg" alt="Flowchart of conditional service routing: after Start the process branches on product type to the Mortgage, Auto Loan or Personal Loan pricing service, then converges on Generate Quote" className="block dark:hidden" />
<img src="/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-6-dark.svg" alt="Flowchart of conditional service routing: after Start the process branches on product type to the Mortgage, Auto Loan or Personal Loan pricing service, then converges on Generate Quote" className="hidden dark:block" />](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-6.svg)
...
[<img src="/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-7.svg" alt="Flowchart of error handling: Start, Primary Service, End; an error boundary event on the Primary Service diverts to a Fallback Service when an error occurs" className="block dark:hidden" />
<img src="/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-7-dark.svg" alt="Flowchart of error handling: Start, Primary Service, End; an error boundary event on the Primary Service diverts to a Fallback Service when an error occurs" className="hidden dark:block" />](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-7.svg)
...
[<img src="/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-lr-8.svg" alt="Flowchart of compensation handling: Reserve Inventory then Charge Payment; if an error occurs, compensation runs Release Inventory and Cancel Order" className="block dark:hidden" />
<img src="/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-lr-8-dark.svg" alt="Flowchart of compensation handling: Reserve Inventory then Charge Payment; if an error occurs, compensation runs Release Inventory and Cancel Order" className="hidden dark:block" />](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-lr-8.svg)
...
[<img src="/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-9.svg" alt="Flowchart of an orchestrated saga: Start Order, Reserve Inventory, Charge Payment, Ship Order, End Success; on failure, compensating steps Refund Payment, Release Inventory and Cancel Order lead to End Cancelled" className="block dark:hidden" />
<img src="/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-9-dark.svg" alt="Flowchart of an orchestrated saga: Start Order, Reserve Inventory, Charge Payment, Ship Order, End Success; on failure, compensating steps Refund Payment, Release Inventory and Cancel Order lead to End Cancelled" className="hidden dark:block" />](/images/architecture/assets/diagrams/core/integration/service-orchestration/flowchart-td-9.svg)
...
- **Learn BPMN Basics:** [BPMN Activities](/architecture/processes/basic-bpmn/activities)
- **Explore Advanced BPMN:** [Advanced BPMN Patterns](/architecture/processes/advanced-bpmn/overview)
- **Event Integration:** [Event-Driven Integration](/architecture/integration/event-driven)
- **Decision Orchestration:** [Decision Process Integration](/architecture/integration/decision-process)
