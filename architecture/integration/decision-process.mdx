...
The `startProcess` method is available exclusively in Aletyx Enterprise for KJAR-packaged applications. See [Drools Ruleflow documentation](https://docs.aletyx.ai/components/drools/drools-ruleflow/) for details.
</Note>
...
[![BPMN flowchart of a hybrid loan process: Start (Loan Application) to a Validate Data service task, then Credit Scoring and Risk Assessment business rule tasks, then an 'Approved?' decision; yes goes to a Final Review user task and End Approved, no goes to End Rejected](/images/architecture/assets/diagrams/core/integration/decision-process/flowchart-lr-2.svg)](/images/architecture/assets/diagrams/core/integration/decision-process/flowchart-lr-2.svg)
...
[![Flowchart of a sequential decision chain: Application Data passes through Validation Rules, Scoring Rules, Pricing Rules and Approval Rules to produce the Decision Output](/images/architecture/assets/diagrams/core/integration/decision-process/flowchart-lr-3.svg)](/images/architecture/assets/diagrams/core/integration/decision-process/flowchart-lr-3.svg)
...
[![Flowchart of parallel decision evaluation: an Application is evaluated simultaneously by Credit Risk Rules, Fraud Detection Rules and Compliance Rules, whose outputs are combined in Aggregate Results to produce the Final Decision](/images/architecture/assets/diagrams/core/integration/decision-process/flowchart-td-4.svg)](/images/architecture/assets/diagrams/core/integration/decision-process/flowchart-td-4.svg)
...
[![Flowchart of conditional decision routing: a Product Application is routed by product type to Mortgage, Auto Loan or Credit Card pricing rules, then converges on Generate Quote](/images/architecture/assets/diagrams/core/integration/decision-process/flowchart-td-5.svg)](/images/architecture/assets/diagrams/core/integration/decision-process/flowchart-td-5.svg)
...
See [Drools Ruleflow Migration](https://docs.aletyx.ai/components/drools/drools-ruleflow/) for detailed migration guidance.
...
- **Learn Rule Units:** [Understanding Rule Units](/architecture/decisions/drl/rule-units)
- **Explore Ruleflows:** [Drools Ruleflow Guide](https://docs.aletyx.ai/components/drools/drools-ruleflow/)
