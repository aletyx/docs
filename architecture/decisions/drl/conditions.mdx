---
title: "Conditions (LHS)"
description: "Write Drools rule conditions (the when section): pattern matching, OOPath, constraint operators, variable binding, not/exists/forall, and accumulate and groupby functions."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/decisions/drl/drl-conditions/"
---
