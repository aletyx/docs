...
[![Diagram of the Phreak memory hierarchy: Rule Memory contains Segment Memory, which in turn contains Node Memory](/images/architecture/assets/diagrams/core/decisions/drl/phreak/flowchart-td-1.svg)](/images/architecture/assets/diagrams/core/decisions/drl/phreak/flowchart-td-1.svg)
