---
title: "DMN"
description: "Overview of DMN in the Aletyx Enterprise Build of Kogito and Drools - DRDs, FEEL, decision tables, hit policies, and conformance level 3 support for DMN 1.1 to 1.5."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/decisions/dmn/"
---
...
For a step-by-step tutorial, see the [DMN Introduction](https://docs.aletyx.ai/guides/tutorials/dmn/dmn-intro/) guide.
...
- [Core DMN Concepts](/architecture/decisions/dmn/concepts): Learn about the fundamental concepts of DMN
- [FEEL Handbook](/architecture/decisions/dmn/feel-handbook): Explore the FEEL expression language
