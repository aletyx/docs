---
title: "Concepts"
description: "Core DMN concepts in Aletyx: DRD components, boxed expressions, decision tables, hit policies, FEEL data types, and decision execution flow."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/decisions/dmn/concepts/"
---
...
- [FEEL Handbook](/architecture/decisions/dmn/feel-handbook): Learn more about the FEEL expression language
- [DMN Listeners](/architecture/decisions/dmn/listeners): Understand how to monitor and extend DMN execution
- [DMN Introduction Tutorial](https://docs.aletyx.ai/guides/tutorials/dmn/dmn-intro/): Follow a step-by-step tutorial
