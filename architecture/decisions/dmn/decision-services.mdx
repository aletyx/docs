...
description: "Design, invoke, and test DMN decision services in Kogito and Drools - output and encapsulated decisions, boxed invocations, BPMN business rule tasks, and Java API calls."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/decisions/dmn/decision-services/"
---
