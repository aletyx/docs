---
title: "Rule Language"
description: "Structure of a Drools DRL rule - declaration, when conditions (LHS), and then actions (RHS) - with bound variables and worked discount rule examples."
