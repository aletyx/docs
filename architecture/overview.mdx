...
- [DRL (Drools Rule Language)](/drools/drl/overview)
- [Decision Tables](/drools/decision-tables/overview)
...
[Decision Tables](/drools/decision-tables/overview) offer a spreadsheet-based approach to rule authoring, making rule management accessible to business users. Decision tables excel at organizing large sets of related rules in a format that business stakeholders can easily understand and modify.
...
- [First Steps with Drools](https://docs.aletyx.ai/drools/getting-started/)
