---
title: "Architecture"
description: "Architecture of Aletyx Enterprise Build of Kogito and Drools - the DRL, DMN, and decision-table decision engine, BPMN process engine, and rule-process integration patterns."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/"
---

A map of how the Aletyx Enterprise Build of Kogito and Drools is built - the decision engine (DRL, decision tables, DMN), the process engine (BPMN), and the patterns that integrate them. Use it to navigate the deep-dive architecture topics below. For the shared vocabulary and fundamentals first, start with [Core Concepts](/core-concepts).
