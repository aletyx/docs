---
title: "Activities"
description: "Tasks (or Activities) are the smallest unit of work within a BPMN process. Each Task represents a single action—whether executed by a system, a human, or a..."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/processes/basic-bpmn/activities/"
---

## BPMN Activities in Aletyx Enterprise Build of Kogito and Drools 10.1.0-aletyx
...
[![Business Rule Task Node](/images/architecture/core/processes/basic-bpmn/images/business-rule-task-node.png)](/images/architecture/core/processes/basic-bpmn/images/business-rule-task-node.png)
...
[![Script Task Node](/images/architecture/core/processes/basic-bpmn/images/script-task-node.png)](/images/architecture/core/processes/basic-bpmn/images/script-task-node.png)
...
[![User Task Node](/images/architecture/core/processes/basic-bpmn/images/user-task-node.png)](/images/architecture/core/processes/basic-bpmn/images/user-task-node.png)
