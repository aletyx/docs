---
title: "Process API"
description: "Interact with Kogito BPMN processes programmatically through the auto-generated domain-specific REST API, the technical /management REST API, and the Java ProcessService API."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/processes/basic-bpmn/api/"
---

## Process API in Aletyx Enterprise Build of Kogito and Drools 10.1.0-aletyx
