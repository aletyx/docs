---
title: "BPMN Basics"
description: "An introduction to BPMN 2.0 basics in jBPM - flow objects (events, activities, gateways), sequence flows, and how jBPM extends the OMG notation for executable workflows."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/processes/basic-bpmn/"
---

## Basic BPMN Nodes in Aletyx Enterprise Build of Kogito and Drools 10.1.0-aletyx
