...
description: "Model adaptable BPMN workflows in Kogito and Drools using ad-hoc processes, ad-hoc sub-processes, milestones, and ad-hoc fragments for dynamic, unstructured work."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/processes/advanced-bpmn/flex-processes/"
---

## Flexible Processes in Aletyx Enterprise Build of Kogito and Drools 10.1.0-aletyx
...
[![Embedded Subprocesses](/images/architecture/core/processes/advanced-bpmn/images/flex-process.png)](/images/architecture/core/processes/advanced-bpmn/images/flex-process.png)
