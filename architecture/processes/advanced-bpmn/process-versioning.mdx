...
description: "Manage BPMN process versioning in Kogito with the parallel deployment pattern - versioned process IDs, client routing via gateways or facades, and cleanup of completed versions."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/processes/advanced-bpmn/new-process-versions/"
---
...
<Warning>
**Process Instance Migration is not a part of Aletyx Enterprise Build of Kogito and Drools 10.1.0-aletyx**
...
[<img src="/images/architecture/core/processes/advanced-bpmn/images/version-to-version.svg" alt="Process SVG Transition" className="block dark:hidden" />
<img src="/images/architecture/core/processes/advanced-bpmn/images/version-to-version-dark.svg" alt="Process SVG Transition" className="hidden dark:block" />](/images/architecture/core/processes/advanced-bpmn/images/version-to-version.svg)
...
[<img src="/images/architecture/core/processes/advanced-bpmn/images/container-single.svg" alt="Single Container with Multiple Versions" className="block dark:hidden" />
<img src="/images/architecture/core/processes/advanced-bpmn/images/container-single-dark.svg" alt="Single Container with Multiple Versions" className="hidden dark:block" />](/images/architecture/core/processes/advanced-bpmn/images/container-single.svg)
...
[<img src="/images/architecture/core/processes/advanced-bpmn/images/container-strategy-2.svg" alt="Multiple Containers with Version-specific Routing" className="block dark:hidden" />
<img src="/images/architecture/core/processes/advanced-bpmn/images/container-strategy-2-dark.svg" alt="Multiple Containers with Version-specific Routing" className="hidden dark:block" />](/images/architecture/core/processes/advanced-bpmn/images/container-strategy-2.svg)
...
[<img src="/images/architecture/core/processes/advanced-bpmn/images/container-strategy-1.svg" alt="Single Container with Multiple Versions" className="block dark:hidden" />
<img src="/images/architecture/core/processes/advanced-bpmn/images/container-strategy-1-dark.svg" alt="Single Container with Multiple Versions" className="hidden dark:block" />](/images/architecture/core/processes/advanced-bpmn/images/container-strategy-1.svg)
