...
description: "Query Kogito process instances and user tasks with GraphQL - where filters and operators, and/or logic, orderBy sorting, and limit/offset pagination."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/processes/advanced-bpmn/graphql/"
---
