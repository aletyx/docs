...
description: "The Process History Service, implemented through the Data-Audit subsystem, provides a comprehensive temporal view of process execution throughout the lifecycle of process instances."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/processes/architecture/data-audit/"
---
...
- [Data Intelligence Layer](/architecture/processes/architecture/data-intelligence-layer)
- [Process Data & Persistence](https://docs.aletyx.ai/core/processes/architecture/data-audit/data.md)
