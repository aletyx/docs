...
description: "Adaptive Process Architecture co-locates jBPM and Kogito services on Quarkus with shared persistence, Data-Index, Jobs Service, and User Tasks for stateful cloud-native process orchestration."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/processes/architecture/compact-architecture/"
---
...
[![Graphical view of the Data-Index subsystem](/images/architecture/core/processes/architecture/images/data-index.png)](/images/architecture/core/processes/architecture/images/data-index.png)

[Learn more about the Data Intelligence Layer](/architecture/processes/architecture/data-intelligence-layer)
...
[Learn more about the Process History Service](/architecture/processes/architecture/process-history)
...
[Learn more about the Temporal Event Coordinator](/architecture/processes/components/job-service)
...
[Learn more about the Human Collaboration Framework](/architecture/processes/components/user-tasks)
...
[Learn more about Data & Persistence](/architecture/processes/components/data-index-audit)
...
To quickly get started with Adaptive Process Architecture, see the [Getting Started Guide](https://docs.aletyx.ai/components/compact-architecture/getting-started/) which covers:
...
- [Key Components](https://docs.aletyx.ai/components/compact-architecture/key-components/)
- [Configuration Guide](https://docs.aletyx.ai/components/compact-architecture/configuration/)
- [Scaling & Performance](https://docs.aletyx.ai/components/compact-architecture/scaling/)
- [Best Practices](https://docs.aletyx.ai/components/compact-architecture/best-practices/)
- [Deployment Guide](https://docs.aletyx.ai/deployment/compact-architecture/basic-setup/)
