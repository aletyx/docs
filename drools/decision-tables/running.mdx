...
description: "Load and execute a spreadsheet decision table (.drl.xlsx) in Java using the KIE API, KieContainer, and KieSession, or compile it to DRL with SpreadsheetCompiler."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/decisions/drl/decision-tables/getting-started/running/"
---
