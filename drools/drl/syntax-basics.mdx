---
title: "Syntax Basics"
description: "A comprehensive overview of DRL syntax: rule structure, attributes, conditions (when), and actions (then) for authoring business rules in Drools."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/decisions/drl/syntax-introduction/"
---
