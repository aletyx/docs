...
description: "How the Query system extracts and analyzes data from the rule engine: traditional and Rule Unit queries, parameters, backward chaining, live queries, and best practices."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/decisions/drl/intro-queries/"
---
