---
title: "Rule Units"
description: "Organize Drools rules with Rule Units - RuleUnitData classes, DataStore, DataStream, and SingletonStore data sources, queries, OOPath, and execution with RuleUnitInstance."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/decisions/drl/rule-units/"
---
...
When using [Kogito](/components/kogito) with Rule Units, REST endpoints are automatically generated:
