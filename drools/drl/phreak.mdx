---
title: "Phreak Algorithm"
description: "How the Phreak algorithm powers rule evaluation in Drools through lazy evaluation, segment sharing, and node/segment/rule memory, and how to write more efficient DRL rules."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/decisions/drl/phreak/"
---
...
[<img src="/images/architecture/assets/diagrams/core/decisions/drl/phreak/flowchart-td-1.svg" alt="Diagram of the Phreak memory hierarchy: Rule Memory contains Segment Memory, which in turn contains Node Memory" className="block dark:hidden" />
<img src="/images/architecture/assets/diagrams/core/decisions/drl/phreak/flowchart-td-1-dark.svg" alt="Diagram of the Phreak memory hierarchy: Rule Memory contains Segment Memory, which in turn contains Node Memory" className="hidden dark:block" />](/images/architecture/assets/diagrams/core/decisions/drl/phreak/flowchart-td-1.svg)
