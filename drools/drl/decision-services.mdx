...
description: "Build a complete DRL decision service step by step using Drools rule units, data stores, salience, JUnit tests, and a REST endpoint for loan approval."
source: "https://aletyx-docs-preview.aletyx.workers.dev/core/decisions/drl/implementing-decision-services/"
---
