...
description: "Reference of DMN FEEL reserved words and keywords - logical, comparison, collection, and temporal operators, built-in data types, and variable naming rules to avoid conflicts."
