...
description: "Reference for DMN Select expression types - Literal, Relation, Context, Decision Table, List, Invocation, Function, Conditional, For, Every, Some, and Filter, with FEEL examples and hit policies."
source: "https://docs.aletyx.ai/reference/dmn/select-reference/"
---
...
| [![Relation icon](/images/reference/reference/dmn/images/icons/table.svg)](https://docs.aletyx.ai/reference/dmn/images/icons/table.svg) | **Relation** | Creates a table structure for organizing data (not to be confused with a decision table). | Reference data, lookup tables, structured data |
...
| [![Decision Table icon](/images/reference/reference/dmn/images/icons/table.svg)](https://docs.aletyx.ai/reference/dmn/images/icons/table.svg) | **Decision Table** | Organizes conditions (inputs) and conclusions (outputs) in a tabular format with hit policies. | Multiple conditions/rules, business rule tables, if-then scenarios |
| [![List icon](/images/reference/reference/dmn/images/icons/list.svg)](https://docs.aletyx.ai/reference/dmn/images/icons/list.svg) | **List** | Creates an ordered collection of values or expressions. | Collections of values, multiple results, aggregations |
...
| [![For icon](/images/reference/reference/dmn/images/icons/for.svg)](https://docs.aletyx.ai/reference/dmn/images/icons/for.svg) | **For** | Iterates over items in a list, applying an expression to each. | Transforming collections, iterating through lists |
| [![Every icon](/images/reference/reference/dmn/images/icons/every.svg)](https://docs.aletyx.ai/reference/dmn/images/icons/every.svg) | **Every** | Tests if a condition is true for every item in a collection. | Validation rules for all items, ensuring conditions are met |
| [![Some icon](/images/reference/reference/dmn/images/icons/some.svg)](https://docs.aletyx.ai/reference/dmn/images/icons/some.svg) | **Some** | Tests if a condition is true for at least one item in a collection. | Finding matching items, checking existence |
| [![Filter icon](/images/reference/reference/dmn/images/icons/filter.svg)](https://docs.aletyx.ai/reference/dmn/images/icons/filter.svg) | **Filter** | Filters a collection based on a specified condition. | Extracting subsets, finding specific items |
