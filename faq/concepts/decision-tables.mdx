...
<CardGroup cols={2}>
  <Card title="Decision Tables" icon="table" href="/architecture/decisions/decision-tables/overview">
    The decision table model in depth, from structure to evaluation.
  </Card>
  <Card title="First Table" icon="play" href="/architecture/decisions/decision-tables/first-table">
  ...
  <Card title="DMN in Playground" icon="play" href="/guides/dmn-playground">
