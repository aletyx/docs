...
<CardGroup cols={2}>
  <Card title="Introduction to DMN" icon="book-open" href="/guides/examples/dmn/dmn-intro">
    Learn the building blocks — decision tables, DRDs, and FEEL — from the ground up.
  </Card>
  <Card title="Try it in the Playground" icon="play" href="/guides/dmn-playground">
    Build and run an executable DMN model directly in the Aletyx Playground.
  </Card>
  <Card title="Basic Examples" icon="table" href="/guides/examples/dmn/dmn-basic-example">
    Walk through a worked example, from inputs to a decision table.
  </Card>
  <Card title="Advanced Modeling" icon="diagram-project" href="/guides/examples/dmn/dmn-deeper">
  ...
  <Card title="Deploy DMN" icon="rocket" href="/guides/examples/dmn/dmn-basic-deployment">
