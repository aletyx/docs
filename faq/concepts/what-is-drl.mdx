...
<CardGroup cols={2}>
  ...
  <Card title="Syntax Basics" icon="code" href="/drools/drl/syntax-basics">
    The fundamentals of DRL syntax and rule structure.
  </Card>
  <Card title="Conditions (LHS)" icon="list" href="/drools/drl/conditions">
    How the when block matches facts in working memory.
  </Card>
  <Card title="Actions (RHS)" icon="gears" href="/drools/drl/actions">
    How the then block defines what happens when a rule fires.
  </Card>
  <Card title="DRL Examples" icon="play" href="/drools/tutorials/drl-example">
