...
<CardGroup cols={2}>
  ...
  <Card title="Getting Started" icon="play" href="/components/drools/drools-getting-started">
    Stand up your first Drools project and run your first rules.
  </Card>
  <Card title="Rule Engine" icon="cube" href="/components/drools/drools-engine">
