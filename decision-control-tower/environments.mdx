...
<img src="/images/decision-control-tower/diagrams/environments/flowchart-lr-1.svg" alt="Flowchart of model promotion across environments: Development, then Submit for Review to Test/UAT, then Approve for Production to Production" className="block dark:hidden" />
<img src="/images/decision-control-tower/diagrams/environments/flowchart-lr-1-dark.svg" alt="Flowchart of model promotion across environments: Development, then Submit for Review to Test/UAT, then Approve for Production to Production" className="hidden dark:block" />
