...
![State diagram of the task workflow: PENDING to ACTIVATED to IN_REVIEW, which can transition to APPROVED then DEPLOYING then DEPLOYED (or FAILED), to REJECTED with resubmission, or to CANCELLED](/images/decision-control-tower/diagrams/tasks/state-2.svg)
