...
![Overview diagram of Aletyx Decision Control Tower: a unified portal (Dashboard, Environments, Governance, Tasks and Audit Trail) managing the Decision Control environments Development, Test/UAT and Production](/images/decision-control-tower/diagrams/index/flowchart-td-1.svg)
