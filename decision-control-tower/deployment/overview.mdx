...
docker run -d --name tower-sidecar --network aletyx-tower \
  ...
  -e ALETYX_CONTROL_TOWER_SIDECAR_DB_URL=jdbc:postgresql://sidecar-postgres:5432/decision_tower_sidecar \
  -e ALETYX_CONTROL_TOWER_SIDECAR_DB_USERNAME=sidecar \
  -e ALETYX_CONTROL_TOWER_SIDECAR_DB_PASSWORD=sidecar \
  -e ALETYX_CONTROL_TOWER_SIDECAR_TOWER_CALLBACK_URL=http://decision-control-tower:8080 \
...
docker run --rm --name decision-control-tower --network aletyx-tower \
  ...
  -e SPRING_DATASOURCE_URL=jdbc:postgresql://tower-postgres:5432/decision_tower_db \
  -e SPRING_DATASOURCE_USERNAME=tower \
  -e SPRING_DATASOURCE_PASSWORD=tower \
  -e ALETYX_CONTROL_TOWER_SIDECAR_URL=http://tower-sidecar:8080 \
  -e ALETYX_CONTROL_TOWER_DATA_INDEX_URL=http://tower-sidecar:8080 \
  -e ALETYX_CONTROL_TOWER_USE_MOCKS=false \
...
data:
  ...
  ALETYX_CONTROL_TOWER_CORS_ALLOWED_ORIGINS: "https://<your-tower-host>"
  SPRING_DATASOURCE_URL: "jdbc:postgresql://<db-host>:5432/<tower-db>"
  SPRING_DATASOURCE_USERNAME: "<tower-db-user>"
  ALETYX_CONTROL_TOWER_SIDECAR_URL: "http://decision-control-tower-sidecar.tower.svc.cluster.local"
  ALETYX_CONTROL_TOWER_DATA_INDEX_URL: "http://decision-control-tower-sidecar.tower.svc.cluster.local"
  ALETYX_CONTROL_TOWER_USE_MOCKS: "false"
  ALETYX_CONTROL_TOWER_ENVIRONMENTS_FILE: "/app/config/environments.json"
  ALETYX_CONTROL_TOWER_SEED_TENANT_ID: "<your-entra-tenant-id>"
...
type: Opaque
stringData:
  SPRING_DATASOURCE_PASSWORD: "<your-tower-db-password>"
...
data:
  ...
  ALETYX_CONTROL_TOWER_SIDECAR_DB_URL: "jdbc:postgresql://<db-host>:5432/<sidecar-db>"
  ALETYX_CONTROL_TOWER_SIDECAR_DB_USERNAME: "<sidecar-db-user>"
  ALETYX_CONTROL_TOWER_SIDECAR_TOWER_CALLBACK_URL: "http://decision-control-tower.tower.svc.cluster.local"
---
apiVersion: v1
kind: Secret
metadata:
...
type: Opaque
stringData:
  ALETYX_CONTROL_TOWER_SIDECAR_DB_PASSWORD: "<your-sidecar-db-password>"
