...
data:
  ...
  SPRING_DATASOURCE_URL: "jdbc:postgresql://postgres.data.svc.cluster.local:5432/decision_tower_db"
  ...
  ALETYX_CONTROL_TOWER_SIDECAR_URL: "http://tower-sidecar.tower-prod.svc.cluster.local"
  ALETYX_CONTROL_TOWER_DATA_INDEX_URL: "http://tower-sidecar.tower-prod.svc.cluster.local"

  # Environment seed file (mounted from tower-static-config)
  ALETYX_CONTROL_TOWER_ENVIRONMENTS_FILE: "/app/config/environments.json"

  # Health probe loop
  ALETYX_CONTROL_TOWER_HEALTH_INTERVAL_MS: "30000"
  ALETYX_CONTROL_TOWER_HEALTH_TIMEOUT: "5"
  ALETYX_CONTROL_TOWER_HEALTH_POOL_SIZE: "4"

  # Task list
  ALETYX_CONTROL_TOWER_TASKS_PAGE_SIZE: "200"
  ALETYX_CONTROL_TOWER_TASKS_FUTURE_TIMEOUT: "5"
  ALETYX_CONTROL_TOWER_TASKS_EXECUTOR_POOL_SIZE: "0"

  # Logging
  ALETYX_CONTROL_TOWER_LOG_LEVEL_ROOT: "INFO"
  ALETYX_CONTROL_TOWER_LOG_LEVEL_APP: "INFO"
  ALETYX_CONTROL_TOWER_LOG_LEVEL_WEB: "ERROR"
  ALETYX_CONTROL_TOWER_LOG_LEVEL_HTTP: "ERROR"
  ALETYX_CONTROL_TOWER_LOG_LEVEL_SQL: "ERROR"
```
...
data:
  ...
  #   spring.datasource.url=${ALETYX_CONTROL_TOWER_SIDECAR_DB_URL}
  #   spring.datasource.username=${ALETYX_CONTROL_TOWER_SIDECAR_DB_USERNAME}
  #   spring.datasource.password=${ALETYX_CONTROL_TOWER_SIDECAR_DB_PASSWORD}
  ALETYX_CONTROL_TOWER_SIDECAR_DB_URL: "jdbc:postgresql://postgres-sidecar.data.svc.cluster.local:5432/sidecar_db"
  ALETYX_CONTROL_TOWER_SIDECAR_DB_USERNAME: "sidecar"

  # Callback URL the Sidecar uses to call back into Tower.
  ALETYX_CONTROL_TOWER_SIDECAR_TOWER_CALLBACK_URL: "http://decision-control-tower.tower-prod.svc.cluster.local"
---
apiVersion: v1
kind: Secret
metadata:
...
2. From a helper pod in the same namespace, check the Sidecar Service is reachable at the URL Tower uses (the value of `ALETYX_CONTROL_TOWER_SIDECAR_URL`):
   ```sh
