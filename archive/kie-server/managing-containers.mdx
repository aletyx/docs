...
description: "Containers within the Execution Server can be started, stopped and updated from within Business Central."
source: "https://docs.jboss.org/jbpm/release/7.67.0.Final/jbpm-docs/html_single/#_managing_containers"
---
