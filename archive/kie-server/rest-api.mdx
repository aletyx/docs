...
For a list of query mappers that are included in jBPM, see the [GitHub repository](https://github.com/kiegroup/jbpm/tree/7.67.2.Final/jbpm-services/jbpm-kie-services/src/main/java/org/jbpm/kie/services/impl/query/mapper).
