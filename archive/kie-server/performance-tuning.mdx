...
- [Development streamline lifecycle](https://docs.jboss.org/jbpm/release/7.67.0.Final/jbpm-docs/html_single/#_development_streamline_lifecycle)
- [Duplicate GAV detection](https://docs.jboss.org/jbpm/release/7.67.0.Final/jbpm-docs/html_single/#_duplicate_gav_detection)
...
[KIE Server capabilities and extensions](/archive/kie-server/extensions).
