...
![The different components of Adaptive Process Architecture](/images/core/processes/images/wf-compact-arch.png)
...
[Learn more about the Data Intelligence Layer](../data-index)
...
[Learn more about the Process History Service](../data-audit)
...
To quickly get started with Adaptive Process Architecture, see the [Getting Started Guide](../../../components/compact-architecture/getting-started) which covers:
...
- [Key Components](../../../components/compact-architecture/key-components)
- [Configuration Guide](../../../components/compact-architecture/configuration)
- [Scaling & Performance](/platform/architecture/scaling)
- [Best Practices](../../../components/compact-architecture/best-practices)
- [Deployment Guide](../../../deployment/compact-architecture/basic-setup)
