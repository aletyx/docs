---
title: "Platform"
description: "The Aletyx Enterprise Build of Kogito and Drools represents a comprehensive business automation platform built on the solid foundation of the Apache KIE open source projects (Drools, jBPM and Kogito) "
source: "https://docs.aletyx.ai/components/"
---
...
1. Start with the [aletyx](https://docs.aletyx.ai/guides/getting-started/) guide for a hands-on introduction
2. Explore the [Aletyx Playground](/components/playground/overview) to create your first projects
3. Dive into specific components based on your needs:
4. For rules and decisions: [Drools](/components/drools/overview)
5. For process orchestration: [jBPM](/components/jbpm) or [Kogito](/components/kogito)
6. Learn about [deployment options](https://docs.aletyx.ai/deployment/) for your production environment

For those already familiar with the Apache KIE projects, our [Migration Guide](https://docs.aletyx.ai/migration-guide/) will help you transition to the aletyx build and take advantage of the additional features.
