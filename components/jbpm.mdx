---
title: "jBPM"
description: "jBPM is a part of the Apache KIE (Incubating) delivering flexible Business Process Management (BPM) that enables organizations to model, execute, and monitor business processes throughout their lifecy"
