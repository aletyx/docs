---
title: "jBPM"
description: "jBPM, the Apache KIE Business Process Management engine in the Aletyx build - BPMN 2.0 process execution, runtime and task services, and integration with Drools, Kogito, and Quarkus."
source: "https://docs.aletyx.ai/components/jbpm/"
---
...
<Note>
Wondering how jBPM relates to Drools, Kogito, and KIE? See [Drools vs. Kogito vs. KIE](/faq/concepts/drools-kogito-kie).
</Note>
...
- [Get started with your first process](/architecture/processes/overview)
- [Understand basic BPMN elements](/architecture/processes/basic-bpmn/overview)
- [Learn about human tasks](/architecture/processes/components/user-tasks)
- [Explore the process engine architecture](/architecture/processes/architecture/engine)
