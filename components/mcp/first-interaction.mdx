...
description: "Build a Spring Boot decision service that exposes a DMN model over the Model Context Protocol (MCP) and connect it to Claude Desktop for natural-language decisions."
