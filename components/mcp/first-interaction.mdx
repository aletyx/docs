...
description: "This guide walks you through setting up a Spring Boot service that combines Decision Model and Notation (DMN) with Model Context Protocol (MCP) to create an intelligent decision service that can inter"
...
2. Select the "Intelligent Decision Service" template
     [![Intelligent Decision Service](/images/components/components/mcp/images/intelligent-decision-service.png)](https://docs.aletyx.ai/components/mcp/images/intelligent-decision-service.png)
