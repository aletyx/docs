---
title: "Playground"
description: "Aletyx Playground is a powerful, browser-based collaboration platform that enables decision engineers and analysts to design, test, and deploy business automation solutions using industry-standard not"
source: "https://docs.aletyx.ai/components/playground/"
---

Aletyx Playground is a powerful, browser-based collaboration platform that enables decision engineers and analysts to design, test, and deploy business automation solutions using industry-standard notations like DMN and BPMN. Built on the Apache KIE Sandbox foundation, Aletyx Playground provides an enterprise-ready experience with additional accelerators and deployment capabilities that streamline the journey from modeling to production. When you use [https://playground.aletyx.ai](https://playground.aletyx.ai), you're using a customized and hosted version of Aletyx Playground.
...
Then access your version of Aletyx Playground at [http://localhost:9090](http://localhost:9090)
...
For more detailed guidance, explore our [Getting Started with Decisions (DMN)](https://docs.aletyx.ai/guides/getting-started/getting-started-playground-dmn) and [Getting Started with Processes (BPMN)](https://docs.aletyx.ai/guides/getting-started/getting-started-playground-bpmn) guides.

## Next Steps

Ready to dive deeper? Explore these resources:

- [Components of Aletyx Playground](/components/playground/components)
- [Detailed DMN Modeling Guide](/guides/examples/dmn/dmn-intro)
- [BPMN Process Modeling](/guides/examples/bpmn-example)
- [Working with Accelerators](/components/playground/accelerators)
- [Development Deployments](/components/playground/dev-deployment)
- [Connecting to Git Providers](https://docs.aletyx.ai/getting-started/git-configuration)
