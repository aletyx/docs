---
title: "Playground"
description: "Aletyx Playground, built on Apache KIE Sandbox, is a browser-based tool to model, test, and deploy DMN and BPMN with Git integration, dev deployments, and accelerators."
...
- [Detailed DMN Modeling Guide](/guides/tutorials/dmn/dmn-intro)
- [BPMN Process Modeling](/guides/tutorials/bpmn-example)
