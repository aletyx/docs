...
description: "Configure a self-hosted Aletyx Playground: environment variables, Git providers (GitHub, Bitbucket), CORS proxy and extended services, custom commit validation, branding, and accelerators."
source: "https://docs.aletyx.ai/deployment/playground/"
---
...
KIE_SANDBOX_CUSTOM_COMMIT_MESSAGE_VALIDATION_SERVICE_URL: [http://localhost:3000/validate](http://localhost:3000/validate)
...
[](https://docs.aletyx.ai/components/playground/self-hosting/images/apply-dmn-accelerator.gif)
