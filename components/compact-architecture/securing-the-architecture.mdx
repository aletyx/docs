...
sidebarTitle: "Securing Console"
description: "Secure your Intelligent Process Orchestrations API endpoints with authentication and authorization, with the example focused on Quarkus."
source: "https://aletyx-docs-preview.aletyx.workers.dev/components/compact-architecture/securing-the-architecture/"
---
