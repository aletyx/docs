...
description: "Aletyx Adaptive Process Architecture co-locates jBPM process components - Data-Index, Data-Audit, Jobs Service, User Tasks, and storage - in a single Quarkus deployment."
source: "https://docs.aletyx.ai/components/compact-architecture/"
---
...
[![The different components of Adaptive Process Architecture](/images/components/components/compact-architecture/images/compact-arch-overall.png)](https://docs.aletyx.ai/components/compact-architecture/images/compact-arch-overall.png)
...
[![Graphical view of the Data-Index subsystem](/images/components/components/compact-architecture/images/data-index.png)](https://docs.aletyx.ai/components/compact-architecture/images/data-index.png)
...
[![Graphical view of the Data-Audit subsystem](/images/components/components/compact-architecture/images/data-audit.png)](https://docs.aletyx.ai/components/compact-architecture/images/data-audit.png)
...
[![Graphical view of the Jobs Service flow](/images/components/components/compact-architecture/images/job_service.svg)](https://docs.aletyx.ai/components/compact-architecture/images/job_service.svg)
...
[](https://docs.aletyx.ai/components/compact-architecture/wf-usertaks-lifecycle.png)
