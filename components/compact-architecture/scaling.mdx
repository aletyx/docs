...
description: "Scale Kogito and Drools process workloads vertically and horizontally with the Temporal Event Coordinator, enabling Kubernetes autoscaling and distributed timer consistency."
source: "https://docs.aletyx.ai/components/compact-architecture/scaling/"
---
...
[<img src="/images/components/assets/images/temporal-architect.svg" alt="Scalable Architecture Diagram" className="block dark:hidden" />
<img src="/images/components/assets/images/temporal-architect-dark.svg" alt="Scalable Architecture Diagram" className="hidden dark:block" />](https://docs.aletyx.ai/assets/images/temporal-architect.svg)
