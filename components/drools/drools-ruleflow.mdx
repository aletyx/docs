---
title: "Rule Flows"
description: "Run classic Drools rule flows on Drools 10 - Aletyx Enterprise keeps the legacy KieSession startProcess API working from a KJAR with the ClassicRuleFlow metadata."
