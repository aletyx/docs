...
![Diagram comparing version management: in the Traditional Approach the app calls separate v1.0 and v2.0 endpoints and you manage routing; in the Decision Control Approach a single API endpoint serves multiple running versions (1.0, 2.0 and 3.0)](/images/decision-control/diagrams/architecture/flowchart-lr-2.svg)
...
![Component diagram of the Pioneer Edition: an Authoring UI over a DMN Execution Engine, Version Management and REST APIs, backed by PostgreSQL](/images/decision-control/diagrams/architecture/flowchart-td-3.svg)
...
![Component diagram of the Innovator Edition: Authoring UI and Prompt UI over a DMN Execution Engine, Version Management, REST APIs and an AI/NLP layer with MCP Server, backed by PostgreSQL](/images/decision-control/diagrams/architecture/flowchart-td-4.svg)
...
![Deployment diagram of the Horizon Edition: a Load Balancer fronts multiple Decision Control replicas (Replica 1, 2 through N), backed by a PostgreSQL primary-plus-replicas database](/images/decision-control/diagrams/architecture/flowchart-td-5.svg)
...
![Network security diagram: traffic from the Internet enters over HTTPS through an Ingress and Load Balancer (TLS termination) to Decision Control, which connects to PostgreSQL over TCP port 5432](/images/decision-control/diagrams/architecture/flowchart-lr-8.svg)
