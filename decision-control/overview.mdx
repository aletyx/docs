...
<img src="/images/decision-control/governance-flow.svg" alt="Governance Flow" className="block dark:hidden" />
<img src="/images/decision-control/governance-flow-dark.svg" alt="Governance Flow" className="hidden dark:block" />
...
<img src="/images/decision-control/architecture-overview.svg" alt="Decision Control Architecture" className="block dark:hidden" />
<img src="/images/decision-control/architecture-overview-dark.svg" alt="Decision Control Architecture" className="hidden dark:block" />
