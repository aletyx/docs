...
**Run** is no longer in this toolbar. To test the model, use the play button at the right end of the model tabs row, or **Run** in the status bar along the bottom of the editor.
