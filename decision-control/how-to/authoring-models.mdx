...
description: "Guides covering the lifecycle of a decision model in the Decisions editor: creating, importing, organizing, syncing, and publishing."
source: "https://aletyx-docs-preview.aletyx.workers.dev/decision-control/how-to/authoring-models/"
---

These guides cover the lifecycle of a decision model in the Decisions editor: creating, importing, organizing, syncing, and publishing. All require Authoring access.

## The Decisions home

When you open Decisions, you land on the home page below. It's where every model starts — either from scratch, from an existing source, or by reopening recent work.

![Decisions home page](/images/decision-control/how-to/authoring-home-page.png)
...
- **Masthead** — the top bar with the Aletyx Platform logo, an info icon, and the gear icon that opens the global **Settings** (Git Providers, Theme, AI Assistant).
...
| 3 | **+ New file** ▾ | Add another file to the workspace. |
| 4 | **Share** ▾ | Download (current file / SVG / workspace ZIP) or embed; in Git-backed workspaces, Sync (push/pull) appears here too. |
| 5 | **⋮** (kebab) | Extra actions: Commit, delete the file, and more. |

**Run** is no longer in this toolbar. To test the model, use the play button at the right end of the model tabs row.
...
<Tabs>
  <Tab title="From a URL">
    ...
    1. Open **Decisions** and find the **From URL** card.
  ...
  <Tab title="Upload from your computer">
    ...
    1. In **Decisions**, go to the **Upload** card.
    2. Drag files/folders onto **Drag & drop files and folders here…**, or click **Select files…** / **Select folder…**.
  </Tab>
</Tabs>

**Verify:** A workspace is created and the model opens in the DMN editor. It also appears under **Recent models** on the Decisions home (replacing the "Nothing here" empty state).
...
**Verify:** The file closes; if it was the last file, you return to the Decisions home.
