...
<Info>
**Executions vs. Execute Decisions history**

These are the **persisted** server-side execution records — they survive reloads and are visible to everyone with Management access. The History tab inside [Execute Decisions](/decision-control/how-to/management-execute#how-to-review-execution-history-in-execute-decisions) is your local replay buffer for the current session.
</Info>
