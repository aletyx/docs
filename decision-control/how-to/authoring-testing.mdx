...
1. At the right end of the model tabs row, open the run options menu (the **▾** next to the play button) and choose **As Form** or **As Table**.
...
**Verify:** Inputs are downloaded, or loaded into the rows.

To copy test data without a file, use the **Actions** menu at the top of the **Inputs** panel: **Copy inputs as JSON** and **Paste inputs from JSON**.
