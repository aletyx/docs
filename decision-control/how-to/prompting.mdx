...
The **Prompting** workspace runs decisions and answers questions about *published* models, for end users. The [in-editor AI Assistant](/decision-control/how-to/authoring-ai) builds and edits decision models inside Decisions, for authors. Different products, different access (Prompting vs Authoring).
</Info>
