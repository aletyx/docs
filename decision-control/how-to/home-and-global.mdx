...
The home page shows one card per workspace: **Decisions**, **Workflows**, **Management**, **Monitoring**, **Prompting**, and **Skills**. The masthead gear icon (top-right) opens the global **Settings**.
...
|-----------|---------------|------|
| **Decisions** | Build and edit DMN decision models | Authoring access |
| **Workflows** | Automate work with flows and processes that connect decisions, data, people, and services | — |
| **Management** | Manage units, versions, models, and execution | Management access |
...
| **Skills** | Browse and download Agent Skills generated from what you deploy | — |
...
**Verify:** The chosen workspace opens — for example, **Decisions** shows the Create / Import / Recent models sections, and **Management** loads its left sidebar with the Dashboard.
...
- **AI Assistant** — store the API key the AI features use. (This tab appears only when the AI SaaS integration is enabled.)
...
3. Make your changes (for example, choose a theme or paste an API key).
