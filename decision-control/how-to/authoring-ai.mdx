...
- **Credential:** a valid AI Assistant API key configured in **Settings → AI Assistant**
</Info>
...
**Verify:** The assistant panel opens with a message box; if no API key is set, a prompt with **Open Settings** and **Subscribe** appears instead.
...
**Prerequisites:** AI Assistant panel open and a valid API key (**Settings → AI Assistant**).
...
## How to configure the AI Assistant API key
...
1. Open **Settings** (masthead cog) → **AI Assistant** (or click **Open Settings** in the no-API-key prompt).

    ![AI Assistant API key settings](/images/decision-control/how-to/ai-token-settings.png)

2. Paste your API key.

**Verify:** The key is stored in your browser and the assistant becomes usable.
