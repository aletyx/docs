...
Manage the catalog of decision units, versions, and models from the Management workbench. All guides on this page require Management access. To execute models, see [Management – Execute Decisions](/decision-control/how-to/management-execute).

The Management workbench uses a left sidebar with **Dashboard**, **Decision Units**, and **Execute Decisions** — the sections below match those entries.
...
A decision unit comes into existence only when you [publish a model from Decisions](/decision-control/how-to/authoring-models#how-to-publish-deploy-a-model). The "Create Decision Unit" button on the dashboard simply opens the Units page. To bring an existing model in first, see [how to import an existing model](/decision-control/how-to/authoring-models#how-to-import-an-existing-model).
</Note>
...
| Play icon | Send the model to Execute Decisions |
...
**Verify:** The Execute Decisions screen opens for that model.
