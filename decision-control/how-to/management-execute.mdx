---
title: "Management – Execute Decisions"
...
![Execute Decisions screen](/images/decision-control/how-to/execute-rules.png)
...
1. Open **Management → Execute Decisions**.
2. Type in **Search by model name**.
...
**Prerequisites:** A model opened in Execute Decisions.
...
## How to review execution history in Execute Decisions
